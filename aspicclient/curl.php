...
class Curl {
    ...
    /**
     * Infos de retour du dernier appel CURL
     * @var string
     */
    ...
    /**
     * Retourne le dernier code HTTP transmis. False si aucun.
     * @return int|boolean
     */
    ...
    /**
     * Retourne le dernier message en tete HTTP transmis. False si aucun.
    ...
    /**
     * Retoure TRUE si la chaine contient une sous-chaîne.
     * @param string $chaine        Chaine à analyser
     * @param tstring $recherche    Chaine à rechercher
     * @param boolean $nocase       Si TRUE : on ne tient pas compte de la casse.
     * @return boolean
     */
